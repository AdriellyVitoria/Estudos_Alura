...
void RegistrarBandas()
{
    ...
    Console.WriteLine($"A banda foi registrada {nomeDaBanda} com sucesso");
    Thread.Sleep(2000);
    Console.Clear();
    ExibirOpcoesDoMenu();
}
...
void MediaDaBanda()
{
    ...
    Console.WriteLine("Qual a banda deseja ver a media? ");
    string nomeDaBanda = Console.ReadLine()!;
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        // Calcular media, soma todas as notas e dividir pela a quantidade
        int soma = 0;
        int totalDeNotas = 0;
